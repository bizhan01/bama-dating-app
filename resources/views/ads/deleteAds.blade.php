<!-- Delete -->
<div class="modal fade" id="delete_{{$ads->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <center class="modal-body">
            	<p class="text-center" style="color: black">آیا از حذف این مورد مطمین هستید؟</p>
      				<!-- <h2 class="text-center" style="color: black">{{$ads->id}}</h2> -->
      			</center>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-remove"></span> لغو</button>
                <a href="{{url('deleteAds').'/' .$ads->id}}" class="btn btn-danger"><span class="fa fa-trash"></span> حذف</a>
            </div>
        </div>
    </div>
</div>
