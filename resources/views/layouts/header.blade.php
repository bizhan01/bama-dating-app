    ...
    <div class="navbar-right navbar-toggleable-sm collapse" id="collapse-1">
      ...
      <ul class="nav navbar-nav  float-md-left" >
        <li class="nav-item dropdown hidden-sm-down">
          <a href="#" data-toggle="dropdown" aria-expanded="false">
            <span class="avatar box-32">
             <img src="/UploadedImages/users/{{Auth::user()->profileImage}}" style="width: 40px; height: 40px;">
            </span>&nbsp;&nbsp;&nbsp;
        ...
        <li class="nav-item dropdown">
          ...
          @include('notification.notificationList')
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false">
            ...
            @if($freindRequestList->count() != 0)
            <span class="tag tag-info top">{{ $freindRequestList->count() }}</span>
            @endif
          </a>
          @include('friends.friendRequestList')
        </li>
