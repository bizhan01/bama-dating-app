<form method="post" action="{{ route('updateUserInfo') }}">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
      ...
      <input type="text" name="phone" placeholder="0799999999" data-mask="0799999999" class="form-control" style="direction: ltr" value="{{Auth::user()->phone}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2"></div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
      ...
      <select name="degree" class="form-control">
        <option>{{Auth::user()->degree}}</option>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
      ...
      <input type="text" name="field_of_study" class="form-control" value="{{Auth::user()->field_of_study}}">
    </div>
    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2"></div>
  </div>
  <div class="row">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
      ...
      <select name="sexual_desire" class="form-control">
        <option>{{Auth::user()->sexual_desire}}</option>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
      ...
      <select name="my_plan" class="form-control">
        <option>{{Auth::user()->my_plan}}</option>
