...
<head>
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="<?php echo e(asset('../vendors/bootstrap4/css/bootstrap.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('../vendors/themify-icons/themify-icons.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('../vendors/font-awesome/css/font-awesome.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('../vendors/animate.css/animate.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('../vendors/jscrollpane/jquery.jscrollpane.css')); ?>">
	...
	<body class="fixed-sidebar fixed-header skin-default">
		...
		<script type="text/javascript" src="../vendors/typeahead/dist/typeahead.jquery.min.js"></script>
		<script type="text/javascript" src="../vendors/typeahead/dist/bloodhound.min.js"></script>
		<!-- <script type="text/javascript" src="../js/forms-typeahead.js"></script> -->
  	...
  	<script type="text/javascript" src="../vendors/autoNumeric/autoNumeric-min.js"></script>
		...
		<script src="<?php echo e(asset('../Persian_Date_Picker_Master/js/prism.js')); ?>"></script>
		<script src="<?php echo e(asset('../Persian_Date_Picker_Master/js/vertical-responsive-menu.min.js')); ?>"></script>
		<!-- <script src="Persian_Date_Picker_Master/js/jquery-1.10.1.min.js"></script> -->
		<script src="<?php echo e(asset('../Persian_Date_Picker_Master/js/persianDatepicker.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\giti\resources\views/layouts/master.blade.php ENDPATH**/ ?>