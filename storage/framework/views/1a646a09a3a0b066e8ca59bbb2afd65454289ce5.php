    ...
    <div class="p-img img-cover" style="background-image: url(/UploadedImages/posts/<?php echo e($post->post_img); ?>);">
      <div class="p-info clearfix">
        <div class="float-xs-left">
          ...
          <a href="#edit_<?php echo e($post->id); ?>" title="ویرایش" data-toggle='modal'>
            <i class="fa fa-edit text-success"></i>
          </a>
          <?php echo $__env->make('post.editPost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

          <a href="#delete_<?php echo e($post->id); ?>" title="حذف" data-toggle='modal'>
            <i class="ti ti-trash text-danger"></i>
          </a>
          <?php echo $__env->make('post.deletePost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php /**PATH C:\xampp\htdocs\BAMA\resources\views/profile/my-posts.blade.php ENDPATH**/ ?>