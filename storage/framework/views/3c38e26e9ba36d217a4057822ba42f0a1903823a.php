							...
							<tbody>
								<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td>
											<a href="#finalStatus_<?php echo e($order->id); ?>" title="تغییر وضعیت" data-toggle='modal'>
												<i class="fa  fa-hourglass-half text-info"></i>
											</a>
											<?php echo $__env->make('order.changeFinalStatus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
											&nbsp;&nbsp;&nbsp;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BAMA\resources\views/order/underProcessOrders.blade.php ENDPATH**/ ?>