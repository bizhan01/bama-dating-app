...
<body class="is-boxed has-animations">
        ...
        <main>
            <section class="hero">
                <div class="container">
                  ...
                  <p class="hero-paragraph">Building Bridges through Accurate Translations</p>
                  <div class="hero-cta">
                    <center>
                      <a class="button button-primary" href="/giti" style="text-transform: capitalize;">Giti Translations</a><hr>
                      <a class="button button-primary" href="#" style="text-transform: capitalize;">Coming Soon</a>
                      <a class="button button-primary" href="#" style="text-transform: capitalize;">Coming Soon</a>
                   </center>
                  </div>
						</div>
			...
			<section class="cta section">
				<div class="container">
					<div class="cta-inner section-inner">
						<h3 class="section-title mt-0">Still not convinced on ordering?</h3>
						<div class="cta-cta">
							<a class="button button-primary button-wide-mobile" href="<?php echo e(route('contactWithUs')); ?>">Get in touch</a>
						</div>
					</div>
				</div>
			</section>
            ...
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <ul class="footer-social-links list-reset">
                        <li>
                            <a href="https://www.facebook.com/profile.php?id=61551994955338&mibextid=ZbWKwL">
                        ...
                        <li>
                            <a href="https://wa.me/93704830998">
    ...
    <script src="<?php echo e(asset('../dist/js/main.min.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\BAMA\resources\views/website/index.blade.php ENDPATH**/ ?>