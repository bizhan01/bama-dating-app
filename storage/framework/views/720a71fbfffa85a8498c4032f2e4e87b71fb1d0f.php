    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Add New Portfolio</h4></center>
            </div>
            <div class="modal-body">
	      		<div class="container-fluid">
              <form method="POST" action="<?php echo e(route('savePortfolio')); ?>" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                  <div class="col-sm-2">
                    <label class="control-label modal-label">Service Category:</label>
                  </div>
                  <div class="col-sm-10">
...
<?php /**PATH C:\xampp\htdocs\giti\resources\views/portfolio/addPortfolio.blade.php ENDPATH**/ ?>