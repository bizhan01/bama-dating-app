<!-- Change Status -->
<div class="modal fade" id="status_<?php echo $order['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
        			<div class="container">
          			<form method="POST" action="/changeStatus/<?php echo $order['id']; ?>">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  <center class="modal-body">
                  	<p class="text-center">Are you sure you want to mark this order under process ?  </p>
...
<?php /**PATH C:\xampp\htdocs\giti\resources\views/order/changeStatus.blade.php ENDPATH**/ ?>