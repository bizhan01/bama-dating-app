    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo e(route('savePost')); ?>" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\BAMA\resources\views/post/addPost.blade.php ENDPATH**/ ?>