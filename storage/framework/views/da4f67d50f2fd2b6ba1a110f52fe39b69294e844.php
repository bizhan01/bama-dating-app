<!-- Edit -->
<div class="modal fade" id="postInfo_<?php echo e($post->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="box bg-white post post-1">
                  <div class="p-content">
                    ...
                    <p class="mb-0"><?php echo e($post->post_description); ?></p>
                  </div>
...
<?php /**PATH C:\xampp\htdocs\BAMA\resources\views/post/postInfo.blade.php ENDPATH**/ ?>